                ...
                <div class="card-body">
                    <form action="/produk/update/{{$detail->id}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_produk" value="{{$detail->nama_produk}}" class="form-control" placeholder="Masukkan nama"/>
                            <small class="form-text text-muted">Masukkan nama produk, dapat berupa string input.</small>
                        </div>

                        <div class="form-group">
                            <label>Stok</label>
                            <input type="number" name="stok" value="{{$detail->stok}}" class="form-control" placeholder="Masukkan stok"/>
                        ...
                        <div class="form-group">
                            ...
                            <select name="brand_id" id="brand_id" class="form-control">
                                ...
                                <option value="{{$item->id}}" {{($detail->brand_id == $item->id) ? 'Selected' : ''}}
                                    >{{$item->nama_brand}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="gudang_id" id="gudang_id" class="form-control">
                                ...
                                <option value="{{$item->id}}" {{($detail->gudang_id == $item->id) ? 'Selected' : ''}}
                                    >{{$item->nama_gudang}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <label>Harga</label>
                            <input type="number" name="harga" value="{{$detail->harga}}" class="form-control" placeholder="Masukkan harga"/>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <h3 class="fs-4 mb-3">Edit Produk</h3>

                <div class="col">
                    <div class="card mb-2">
                        <div class="card-header">Edit Detail {{$detail->nama_produk}}</div>
                            <div class="card-body">
                                <form action="/produk/update/{{$detail->id}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Nama Produk</label>
                                        <input type="text" name="nama_produk" value="{{$detail->nama_produk}}" class="form-control" placeholder="Masukkan nama" required/>
                                    </div>

                                    <div class="form-group">
                                        <label>Stok</label>
                                        <input type="number" name="stok" value="{{$detail->stok}}" class="form-control" placeholder="Masukkan stok" required/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Harga</label>
                                        <input type="number" name="harga" value="{{$detail->harga}}" class="form-control" placeholder="Masukkan harga" required/>
                                    </div>
