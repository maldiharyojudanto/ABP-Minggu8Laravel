...
<body>
    <div class="container">
        <h1>Edit Brand</h1>
        <div class="card my-4">
            <div class="card-header">Edit detail brand</div>
            <div class="card-body">
                <form action="/brand/update/{{$detail->id}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>Nama Brand</label>
                        <input type="text" name="nama_brand" value="{{$detail->nama_brand}}" class="form-control" placeholder="Masukkan nama"/>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <h3 class="fs-4 mb-3">Edit Brand</h3>

                <div class="col">
                    <div class="card mb-2">
                        <div class="card-header">Edit Detail {{$detail->nama_brand}}</div>
                            <div class="card-body">
                                <form action="/brand/update/{{$detail->id}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Nama Brand</label>
                                        <input type="text" name="nama_brand" value="{{$detail->nama_brand}}" class="form-control" placeholder="Masukkan nama" required/>
                                    </div>
